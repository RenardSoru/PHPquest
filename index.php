...
<form action="#" method="post" enctype="multipart/form-data" align="left"> <!-- //~~ -->
	...
	<a href="#close" title="Закрыть" class="close">X</a>
		...
		<div>
		<p>Введите номер телефона + <input style="position:relative;" type="number" pattern="\d*" class="phonecodeField" id="phonecode" name="phonecode" required placeholder="Введите номер телефона" style="margin-left:28px; width:140px;" maxlength="18" /></p>
		<br>
		<table class="rows">
		</table>
		<div class="load"></div>
